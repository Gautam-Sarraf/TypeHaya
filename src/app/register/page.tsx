      ...
      <div className="flex-1 w-full max-w-md mx-auto px-4 sm:px-6 py-12 flex flex-col justify-center">
        <div className="p-8 sm:p-10 rounded-3xl hud-glass shadow-2xl flex flex-col gap-6 border border-white/5">
          ...
          <div className="flex flex-col gap-1 text-center">
            ...
            <h1 className="text-2xl font-extrabold tracking-tight font-display">Enlist in Arena</h1>
            <p className="text-xs font-mono opacity-60" style={{ color: "var(--sub-color)" }}>
              Create your profile to compete globally and build your typing streak.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 font-mono text-xs">
            ...
            >
              <span>{isLoading ? "Creating Profile..." : "Initialize Profile"}</span>
          ...
          >
            ...
            <span>
              Your browser guest test records will seamlessly migrate into your newly registered profile.
            </span>
          </div>
